...
.snip1135 .noanim a:before,
.snip1135 .noanim a:after {
  bottom: 0;
  display: block;
  height: 0px;
  width: 0%;
...
.dot {
  ...
  width: 100%;
  height: 100%;
  background: url(./overlays/06.png);
  z-index: 10;
}
...
/* discography.html----------------------------------------------------------- */
.discographydiv {
  background: url(./img/gray_singer9.jpg);
  background-repeat: no-repeat;
  background-attachment: fixed;
  background-size: cover;
  margin-top: 0px;
...
.communityimg {
  background: url(./img/gray_Main1.jpg);
  background-size: cover;
...
/* blog.html----------------------------------------------------------- */
.blogdiv {
  background: url(./img/gray_singer2.jpg);
  background-repeat: no-repeat;
  background-attachment: fixed;
  background-size: cover;
  margin-top: 0px;
...
/* access.html----------------------------------------------------------- */
.accessdiv {
  background: url(./img/gray_syugou09.jpg);
  background-repeat: no-repeat;
  background-attachment: fixed;
  background-size: cover;
  margin-top: 0px;
